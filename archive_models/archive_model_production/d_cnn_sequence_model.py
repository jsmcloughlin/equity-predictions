...
cnn_seq_model.save('/home/ubuntu/model_test/saved_models/cnn_seq_model.h5')
print("Saved model to disk")

# load model
cnn_seq_model = load_model('/home/ubuntu/model_test/saved_models/cnn_seq_model.h5') # summarize model. model.summary()